...
(context: Context, attrs: AttributeSet) : View(context, attrs) {
    ...
    init {
        ...
        laserColor = resources.getColor(R.color.encode_view)
...
//            scannerAlpha = (scannerAlpha + 1) % SCANNER_ALPHA.size
            ...
            lineRect.top = middle
            lineRect.bottom = middle + 18
            canvas.drawBitmap((resources.getDrawable(R.drawable.scan_qr_line_white) as BitmapDrawable).bitmap, null, lineRect, paint)
